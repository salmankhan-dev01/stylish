...
fun PaymentScreen(
    ...
    val addOrderState by orderScreenViewModel.addOrderState.collectAsState()
    LaunchedEffect(addOrderState) {
        if (addOrderState is Result.Success) {
            showPopup = true
        ...
        LazyColumn(
           ...
           item {
               ...
               Box(
                   ...
                   if(addOrderState is Result.Loading){
            ...
            item {
                ...
                Button(
                    onClick = {
                        orderScreenViewModel.addOrderProduct()
